...
product = Product.create!(title: 'Paying debts.',
  description:
    %(<p>
      <em>Debts</em>
      Paying debts is a book that will help you to get rid of your debts. It
      will help you to understand the importance of paying debts and how to
      manage your finances. It will also help you to understand the importance
      of saving money and how to save money. This book will help you to get rid
      of your debts and live a debt-free life.
    </p>),
  price: 58.95)

product.image.attach(io: File.open(
  Rails.root.join('db', 'images', 'debt_free.jpg')),
    filename: 'debt_free.jpg')
